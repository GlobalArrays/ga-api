...
\begin{tabular}{ p{0.17\textwidth} p{0.15\textwidth} p{0.5\textwidth} p{0.1\textwidth} }
}{
\end{tabular}
}
...
\newcommand{\inarg}[3]{
\texttt{#1} & \texttt{#2} & \texttt{#3} & \textcolor{blue}{\texttt{input}} \\
}

\newcommand{\inoutarg}[3]{
\texttt{#1} & \texttt{#2} & \texttt{#3} & \texttt{\textcolor{blue}{input}/\textcolor{red}{output}} \\
}

\newcommand{\outarg}[3]{
\texttt{#1} & \texttt{#2} & \texttt{#3} & \textcolor{red}{\texttt{output}} \\
}
