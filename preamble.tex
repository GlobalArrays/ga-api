...
\newcommand{\wcoll}{Collective on the world processor group}
\newcommand{\dcoll}{Collective on the default processor group}
\newcommand{\gcoll}{Collective on the global array's processor group}
\newcommand{\ncoll}{One-sided (non-collective)}
