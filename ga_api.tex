...
\apih{PGROUP SPLIT}{Creates a set of new groups by dividing a parent group into
...
\apih{SPRS ARRAY CREATE FROM SPARSE}{Creates a conventional dense array from a
sparse  array}
\begin{capi}
\begin{ccode}
...
\apih{SPRS ARRAY DNSSPRS MULTIPLY}{Multiply a dense matrix by a sparse matrix to
get a dense matrix}
...
\apih{SPRS ARRAY MATMAT MULTIPLY}{Multiply two sparse matrices to get a third
sparse matrix}
...
\apih{SPRS ARRAY ROW DISTRIBUTION}{Find rows of sparse array owned by process
iproc}
\begin{capi}
\begin{ccode}
...
\apih{SPRS ARRAY SPRSDNS MULTIPLY}{Multiply a sparse matrix by a dense matrix to
get a dense matrix}
