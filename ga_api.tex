...
\funcarg{char**}{argv}{command line arguments}{input}
\funcarg{size_t}{limit}{amount of memory in bytes per process}{input}
\funcarg{unsigned long}{heapSize}{all of the dynamically allocated local memory}{input}
\funcarg{unsigned long}{stackSize}{all of the dynamically allocated local memory}{input}
\funcarg{int}{type}{data type}{input}
\end{funcargs}
\end{cxxapi}
...
\end{ccode}
\begin{funcargs}
\funcarg{int*}{list[size]}{list of processor IDs in group}{input}
\funcarg{int}{size}{number of processors in group}{input}
\end{funcargs}
\end{capi}
...
\begin{funcargs}
\funcarg{int}{size}{number of processors in group}{input}
\funcarg{int*}{plist[size]}{list of processor IDs in group}{input}
\end{funcargs}
\end{cxxapi}
...
\end{pycode}
\begin{funcargs}
\funcarg{iterable of ints}{list}{list of processor IDs in group}{input}
\end{funcargs}
\end{pyapi}
...
\end{ccode}
\begin{funcargs}
\funcarg{int}{p_handle}{processor group handle}{input}
\end{funcargs}
\end{capi}
...
\end{pycode}
\begin{funcargs}
\funcarg{int}{pgroup}{processor group handle}{input}
\end{funcargs}
\end{pyapi}
...
\end{cxxcode}
\begin{funcargs}
\funcarg{PGroup*}{p_handle}{processor group}{input}
\end{funcargs}
\end{cxxapi}
...
\end{ccode}
\begin{funcargs}
\funcarg{char*}{array_name}{a unique character string}{input}
\funcarg{int}{type}{data type (MT_F_DBL,MT_F_INT,MT_F_DCPL)}{input}
\funcarg{int}{ndim}{number of array dimensions}{input}
\funcarg{int*}{dims[ndim]}{array of dimensions}{input}
\funcarg{int*}{chunk[ndim]}{array of chunks, each element specifies minimum size that given dimensions should be chunked up into}{input}
\end{funcargs}
\end{capi}
...
\end{pycode}
\begin{funcargs}
\funcarg{str}{name}{a unique character string}{input}
\funcarg{int}{type}{data type e.g. C_DBL, C_INT, C_DCPL}{input}
\funcarg{iter of ints}{dims}{shape of array}{input}
\funcarg{iter of ints}{chunk}{each element specifies minimum size that given dimensions should be chunked up into}{input}
\funcarg{int}{pgroup}{processor group handle}{input}
\end{funcargs}
\end{pyapi}
...
\funcarg{int*}{dims[ndim]}{array of dimensions}{input}
\funcarg{int*}{chunk[ndim]}{array of chunks, each element specifies minimum size that given dimensions should be chunked up into}{input}
\funcarg{int}{p_handle}{processor list handle}{input}
\end{funcargs}
\end{capi}
