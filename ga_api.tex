...
\seealso{CREATE CONFIG,CREATE GHOST IRREG,CREATE GHOSTS,CREATE GHOSTS CONFIG,CREATE GHOSTS IRREG CONFIG,CREATE HANDLE,CREATE IRREG,CREATE IRREG CONFIG}
...
\apih{CREATE GHOST IRREG}{Creates an irregular-distributed GA with ghost cells}
...
\apih{NBGET}{Gets from a global array without blocking the calling process}
...
\apih{NBPUT}{Puts into a global array without blocking the calling process}
...
\apih{NBACC}{Accumulates into a global array without blocking the calling process}
